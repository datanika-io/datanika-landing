...
2. Fill in **Upload name** (letters, digits and spaces — anything else is stripped as you type, so `sales-daily-sync` becomes `salesdailysync`) and an optional **Description**.
