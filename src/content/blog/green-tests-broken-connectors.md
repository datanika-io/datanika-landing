...
*Datanika is an open-source platform that runs dlt extract-and-load and dbt-core transformations behind one UI, with [35 connectors](/connectors), scheduling and run history. [Self-host it](/docs/self-hosting/) or [start free](https://app.datanika.io/signup).*
