...
describe("connector guide screenshots (landing#395)", () => {
  ...
  it("the number of guides proving data landed does not go backwards", () => {
    ...
    // 🔒 RATCHET. 13 as of 2026-09-16: csv, duckdb, json, mongodb, mssql, mysql, openapi, parquet,
    // postgresql, rest-api, shopify, sqlite, stripe (8 on 2026-09-07; the openapi walk added one,
    // landing#572, the mysql walk another, the mssql and mongodb walks two more, and the sqlite
    // walk one, landing#395). The clickhouse walk added none: its destination has no Data preview
    // to capture (landing#604).
